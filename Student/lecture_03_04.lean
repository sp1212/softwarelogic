...
currently extend the material presented at the
...
/-!
this takes 5 arguments as inputs and returns the rightmost function
-/
...
/-!
function that takes one type alpha, a function of alpha to alpha, and returns a function of type alpha to alpha
applies the given function twice to its argument
applied to
-/
