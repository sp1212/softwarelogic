...
/-
applying the function zero times just returns the arg
use lambda when returning a function
remember everything is right-associative
-/
...
def e' : List Nat := [] -- list notation for same thing, empty list
